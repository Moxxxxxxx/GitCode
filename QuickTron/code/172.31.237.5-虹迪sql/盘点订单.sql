...
SELECT DATE_FORMAT(se.entry_time,'%Y-%m-%d %H:00:00') times,
	...
	WHERE se.biz_type LIKE '%CYCLE%' and se.entry_time >= DATE_ADD(DATE_FORMAT(sysdate(),'%Y-%m-%d 00:00:00'),INTERVAL -1 DAY) AND se.entry_time < DATE_FORMAT(sysdate(),'%Y-%m-%d 00:00:00') AND se.project_code = 'C35052' 
