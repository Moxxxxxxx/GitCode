...
SUM(pod.fulfill_quantity)/TIMESTAMPDIFF(SECOND,po.udf4,po.done_date)/3600 as '拣选总效率(pcs/h)',                 -- 取值于拣选商品总个数/拣选单总时间(s)/3600
...
IFNULL(tt4.bucket_wait_time,0) as '货架等待时长',                                                             -- 取值于station_entry表的上一个出站和下一个进站的时间差
