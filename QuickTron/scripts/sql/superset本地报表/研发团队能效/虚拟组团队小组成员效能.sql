...
(
  ...
  WHERE t2.ones_user_uuid is not null AND (SUBSTRING_INDEX(SUBSTRING_INDEX(t1.git_repo,'/',2),'/',-1)  = 'phoenix' OR t1.git_repo='hardware/upper_computer/upper_computer.git') AND t1.git_repo != 'software/phoenix/aio/phoenix-rcs-aio.git'
