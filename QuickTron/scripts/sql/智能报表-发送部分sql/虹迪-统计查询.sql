...
FROM evo_station.station_entry se
WHERE se.biz_type = 'PICKING_ONLINE_G2P_W2P' AND se.last_updated_date >= DATE_ADD(DATE_FORMAT(sysdate(),'%Y-%m-%d 00:00:00'),INTERVAL -1 DAY) AND se.last_updated_date < DATE_FORMAT(sysdate(),'%Y-%m-%d 00:00:00') AND se.project_code = 'C35052'
...
WHERE cmj.updated_date >= DATE_ADD(DATE_FORMAT(sysdate(),'%Y-%m-%d 00:00:00'),INTERVAL -1 DAY) AND cmj.updated_date < DATE_FORMAT(sysdate(),'%Y-%m-%d 00:00:00') AND cmj.biz_type = 'W2P_ONLINE_PICK' AND cmj.state='DONE' AND cmj.project_code = 'C35052'
...
WHERE cmj.updated_date >= DATE_ADD(DATE_FORMAT(sysdate(),'%Y-%m-%d 00:00:00'),INTERVAL -1 DAY) AND cmj.updated_date < DATE_FORMAT(sysdate(),'%Y-%m-%d 00:00:00') AND cmj.biz_type = 'W2P_ONLINE_PICK' AND cmj.state='DONE' AND jsc.state = 'INIT_JOB' AND cmj.project_code = 'C35052' AND jsc.project_code = 'C35052'
GROUP BY cmj.station_code,DATE_FORMAT(cmj.updated_date,'%Y-%m-%d %H:00:00')
)tmp5
...
WHERE sc.state = 'PULLED' AND sc.last_updated_date >= DATE_ADD(DATE_FORMAT(sysdate(),'%Y-%m-%d 00:00:00'),INTERVAL -1 DAY) AND sc.last_updated_date < DATE_FORMAT(sysdate(),'%Y-%m-%d 00:00:00') AND sc.project_code = 'C35052' AND t.project_code = 'C35052' AND g.project_code = 'C35052' AND pj.project_code = 'C35052'
)tmp
...
JOIN evo_wcs_g2p.w2p_picking_job_v2 pj
ON g.job_id = pj.job_id
WHERE sc.state = 'DONE' AND sc.project_code = 'C35052' AND t.project_code = 'C35052' AND g.project_code = 'C35052' AND pj.project_code = 'C35052'
...
SELECT 
 ...
 0 '平均两次任务间隔时长/秒'
  ...
  AND seq.biz_type = 'PICKING_ONLINE_G2P_W2P' AND seq.project_code = 'C35052' 
...
SELECT  DATE_FORMAT(cc.last_updated_date,'%Y-%m-%d %H:00:00') times,
	...
	WHERE cc.state = 'DONE' AND cc.last_updated_date >= DATE_ADD(DATE_FORMAT(sysdate(),'%Y-%m-%d 00:00:00'),INTERVAL -1 DAY) and cc.last_updated_date < DATE_FORMAT(sysdate(),'%Y-%m-%d 00:00:00') AND cc.project_code = 'C35052' 
...
SELECT DATE_FORMAT(cwd.updated_date,'%Y-%m-%d %H:00:00') times,
	...
	WHERE cwd.state = 'DONE' AND cj.state= 'DONE' AND cwd.updated_date >= DATE_ADD(DATE_FORMAT(sysdate(),'%Y-%m-%d 00:00:00'),INTERVAL -1 DAY) and cwd.updated_date < DATE_FORMAT(sysdate(),'%Y-%m-%d 00:00:00') AND cwd.project_code = 'C35052' AND cj.project_code = 'C35052' 
...
WHERE ccd.last_updated_date >= DATE_ADD(DATE_FORMAT(sysdate(),'%Y-%m-%d 00:00:00'),INTERVAL -1 DAY) and ccd.last_updated_date < DATE_FORMAT(sysdate(),'%Y-%m-%d 00:00:00') AND ccd.project_code = 'C35052'
...
SELECT DATE_FORMAT(se.entry_time,'%Y-%m-%d %H:00:00') times,
     ...
     0 'sku_num',
       count(se.id) into_station_times
    FROM evo_station.station_entry se
	WHERE se.biz_type = 'CYCLECOUNT_ONLINE_G2P_W2P' and se.entry_time >= DATE_ADD(DATE_FORMAT(sysdate(),'%Y-%m-%d 00:00:00'),INTERVAL -1 DAY) AND se.entry_time < DATE_FORMAT(sysdate(),'%Y-%m-%d 00:00:00') AND se.project_code = 'C35052' 
	GROUP BY DATE_FORMAT(se.entry_time,'%Y-%m-%d %H:00:00')
...
select DATE_FORMAT(se.last_updated_date,'%Y-%m-%d %H:00:00') times, -- '工作时间/小时'
        se.station_code -- '工作站编码'
FROM evo_station.station_entry se
WHERE se.biz_type = 'CYCLECOUNT_ONLINE_G2P_W2P' AND se.last_updated_date >= DATE_ADD(DATE_FORMAT(sysdate(),'%Y-%m-%d 00:00:00'),INTERVAL -1 DAY) AND se.last_updated_date < DATE_ADD(DATE_ADD(DATE_FORMAT(sysdate(),'%Y-%m-%d 00:00:00'),INTERVAL -1 DAY),INTERVAL 1 DAY) AND se.project_code = 'C35052'
GROUP BY se.station_code,DATE_FORMAT(se.last_updated_date,'%Y-%m-%d %H:00:00')
)tmp1
LEFT JOIN
(
select DATE_FORMAT(cmj.updated_date,'%Y-%m-%d %H:00:00') times,
       ...
       count(cmj.target_way_point_code) as 'num' -- '单工作站双作业点位完成箱数'
FROM evo_wcs_g2p.container_move_job_v2 cmj
WHERE cmj.updated_date >= DATE_ADD(DATE_FORMAT(sysdate(),'%Y-%m-%d 00:00:00'),INTERVAL -1 DAY) AND cmj.updated_date < DATE_ADD(DATE_ADD(DATE_FORMAT(sysdate(),'%Y-%m-%d 00:00:00'),INTERVAL -1 DAY),INTERVAL 1 DAY) AND cmj.biz_type = 'W2P_ONLINE_COUNTCHECK' AND cmj.state='DONE' AND cmj.project_code = 'C35052'
GROUP BY cmj.station_code,DATE_FORMAT(cmj.updated_date,'%Y-%m-%d %H:00:00')
)tmp2
on tmp1.station_code = tmp2.station_code and tmp1.times = tmp2.times
LEFT JOIN
...
WHERE wcj.updated_date >= DATE_ADD(DATE_FORMAT(sysdate(),'%Y-%m-%d 00:00:00'),INTERVAL -1 DAY) AND  wcj.updated_date < DATE_ADD(DATE_ADD(DATE_FORMAT(sysdate(),'%Y-%m-%d 00:00:00'),INTERVAL -1 DAY),INTERVAL 1 DAY) AND wcj.state='DONE' AND wcj.project_code = 'C35052'
...
JOIN evo_wcs_g2p.job_state_change jsc
ON cmj.job_id = jsc.job_id
WHERE cmj.updated_date >= DATE_ADD(DATE_FORMAT(sysdate(),'%Y-%m-%d 00:00:00'),INTERVAL -1 DAY) AND cmj.updated_date < DATE_ADD(DATE_ADD(DATE_FORMAT(sysdate(),'%Y-%m-%d 00:00:00'),INTERVAL -1 DAY),INTERVAL 1 DAY) AND cmj.biz_type = 'W2P_ONLINE_COUNTCHECK' AND cmj.state='DONE' AND jsc.state = 'INIT_JOB' AND cmj.project_code = 'C35052' AND jsc.project_code = 'C35052'
GROUP BY cmj.station_code,DATE_FORMAT(cmj.updated_date,'%Y-%m-%d %H:00:00')
)tmp5
on tmp1.station_code = tmp5.station_code and tmp1.times = tmp5.times
LEFT JOIN
...
WHERE sc.state = 'PULLED' AND sc.last_updated_date >= DATE_ADD(DATE_FORMAT(sysdate(),'%Y-%m-%d 00:00:00'),INTERVAL -1 DAY) AND sc.last_updated_date < DATE_ADD(DATE_ADD(DATE_FORMAT(sysdate(),'%Y-%m-%d 00:00:00'),INTERVAL -1 DAY),INTERVAL 1 DAY) AND sc.project_code = 'C35052' AND t.project_code = 'C35052' AND wcj.project_code = 'C35052'
)tmp
ON jsc.job_id = tmp.job_id
WHERE jsc.updated_date >= DATE_ADD(DATE_FORMAT(sysdate(),'%Y-%m-%d 00:00:00'),INTERVAL -1 DAY) AND jsc.updated_date < DATE_ADD(DATE_ADD(DATE_FORMAT(sysdate(),'%Y-%m-%d 00:00:00'),INTERVAL -1 DAY),INTERVAL 1 DAY) AND jsc.state = 'DONE' AND jsc.project_code = 'C35052' AND wcj.project_code = 'C35052'
...
JOIN evo_wcs_g2p.w2p_countcheck_job_v2 wcj
ON t.task_no = wcj.job_id
WHERE sc.state = 'DONE' AND sc.project_code = 'C35052' AND t.project_code = 'C35052' AND wcj.project_code = 'C35052'
ORDER BY sc.last_updated_date
)tmp
ON sc.station_task_id = tmp.station_task_id 
WHERE sc.state = 'NEW' AND sc.last_updated_date >= DATE_ADD(DATE_FORMAT(sysdate(),'%Y-%m-%d 00:00:00'),INTERVAL -1 DAY) AND sc.last_updated_date < DATE_ADD(DATE_ADD(DATE_FORMAT(sysdate(),'%Y-%m-%d 00:00:00'),INTERVAL -1 DAY),INTERVAL 1 DAY) AND sc.project_code = 'C35052' AND t.project_code = 'C35052' 
ORDER BY tmp.station_code,sc.last_updated_date
)a,(SELECT @i:= 0) b
)a
LEFT JOIN
...
SELECT 
 ...
 0 '平均两次任务间隔时长/秒'
  FROM evo_station.station_entry seq,
       ...
       WHERE @t < DATE_ADD(DATE_FORMAT(sysdate(),'%Y-%m-%d 00:00:00'),INTERVAL -1 HOUR)) tmp_line
  WHERE ((seq.entry_time >= DATE_ADD(DATE_FORMAT(sysdate(),'%Y-%m-%d 00:00:00'),INTERVAL -1 DAY) and seq.entry_time <= DATE_FORMAT(sysdate(),'%Y-%m-%d 00:00:00'))OR (seq.exit_time >= DATE_ADD(DATE_FORMAT(sysdate(),'%Y-%m-%d 00:00:00'),INTERVAL -1 DAY) and seq.exit_time <= DATE_FORMAT(sysdate(),'%Y-%m-%d 00:00:00')) OR (seq.entry_time <= DATE_ADD(DATE_FORMAT(sysdate(),'%Y-%m-%d 00:00:00'),INTERVAL -1 DAY) and seq.exit_time >= DATE_FORMAT(sysdate(),'%Y-%m-%d 00:00:00')))
  AND seq.biz_type = 'CYCLECOUNT_ONLINE_G2P_W2P' AND seq.project_code = 'C35052' 
GROUP BY tmp_line.ids,seq.station_code
)tt
GROUP BY tt.times,tt.station_code;
...
SELECT 
 ...
 0 '平均两次任务间隔时长/秒'
  FROM evo_station.station_entry seq,
       ...
       WHERE @t < DATE_ADD(DATE_FORMAT(sysdate(),'%Y-%m-%d 00:00:00'),INTERVAL -1 HOUR)) tmp_line
  WHERE ((seq.entry_time >= DATE_ADD(DATE_FORMAT(sysdate(),'%Y-%m-%d 00:00:00'),INTERVAL -1 DAY) and seq.entry_time <= DATE_FORMAT(sysdate(),'%Y-%m-%d 00:00:00'))OR (seq.exit_time >= DATE_ADD(DATE_FORMAT(sysdate(),'%Y-%m-%d 00:00:00'),INTERVAL -1 DAY) and seq.exit_time <= DATE_FORMAT(sysdate(),'%Y-%m-%d 00:00:00')) OR (seq.entry_time <= DATE_ADD(DATE_FORMAT(sysdate(),'%Y-%m-%d 00:00:00'),INTERVAL -1 DAY) and seq.exit_time >= DATE_FORMAT(sysdate(),'%Y-%m-%d 00:00:00')))
  AND seq.biz_type = 'PUTAWAY_ONLINE_G2P_GUIDED_W2P' AND seq.project_code = 'C35052' 
GROUP BY tmp_line.ids,seq.station_code
)tt
GROUP BY tt.times,tt.station_code;
...
select DATE_FORMAT(se.last_updated_date,'%Y-%m-%d %H:00:00') times, -- '工作时间/小时'
        se.station_code -- '工作站编码'
FROM evo_station.station_entry se
WHERE se.biz_type = 'PUTAWAY_ONLINE_G2P_DIRECT_W2P' AND se.last_updated_date >= DATE_ADD(DATE_FORMAT(sysdate(),'%Y-%m-%d 00:00:00'),INTERVAL -1 DAY) AND se.last_updated_date < DATE_FORMAT(sysdate(),'%Y-%m-%d 00:00:00') AND se.project_code = 'C35052'
GROUP BY se.station_code,DATE_FORMAT(se.last_updated_date,'%Y-%m-%d %H:00:00')
)tmp1
LEFT JOIN
(
select DATE_FORMAT(cmj.updated_date,'%Y-%m-%d %H:00:00') times,
       ...
       count(cmj.target_way_point_code) as 'num' -- '单工作站双作业点位完成箱数'
FROM evo_wcs_g2p.container_move_job_v2 cmj
WHERE cmj.updated_date >= DATE_ADD(DATE_FORMAT(sysdate(),'%Y-%m-%d 00:00:00'),INTERVAL -1 DAY) AND cmj.updated_date < DATE_FORMAT(sysdate(),'%Y-%m-%d 00:00:00') AND cmj.biz_type = 'W2P_ONLINE_PUTAWAY' AND cmj.state='DONE' AND cmj.project_code = 'C35052'
GROUP BY cmj.station_code,DATE_FORMAT(cmj.updated_date,'%Y-%m-%d %H:00:00')
)tmp2
on tmp1.station_code = tmp2.station_code and tmp1.times = tmp2.times
LEFT JOIN
...
JOIN evo_wcs_g2p.job_state_change jsc
ON cmj.job_id = jsc.job_id
WHERE cmj.updated_date >= DATE_ADD(DATE_FORMAT(sysdate(),'%Y-%m-%d 00:00:00'),INTERVAL -1 DAY) AND cmj.updated_date < DATE_FORMAT(sysdate(),'%Y-%m-%d 00:00:00') AND cmj.biz_type = 'W2P_ONLINE_PUTAWAY' AND cmj.state='DONE' AND jsc.state = 'INIT_JOB' AND cmj.project_code = 'C35052' AND jsc.project_code = 'C35052'
GROUP BY cmj.station_code,DATE_FORMAT(cmj.updated_date,'%Y-%m-%d %H:00:00')
)tmp5
on tmp1.station_code = tmp5.station_code and tmp1.times = tmp5.times
LEFT JOIN
...
JOIN evo_wcs_g2p.w2p_putaway_job_v2 wpj
ON t.task_no = wpj.job_id
WHERE sc.state = 'PULLED' AND sc.last_updated_date >= DATE_ADD(DATE_FORMAT(sysdate(),'%Y-%m-%d 00:00:00'),INTERVAL -1 DAY) AND sc.last_updated_date < DATE_FORMAT(sysdate(),'%Y-%m-%d 00:00:00') AND sc.project_code = 'C35052' AND t.project_code = 'C35052' AND wpj.project_code = 'C35052'
)tmp
ON jsc.job_id = tmp.job_id
WHERE jsc.updated_date >= DATE_ADD(DATE_FORMAT(sysdate(),'%Y-%m-%d 00:00:00'),INTERVAL -1 DAY) AND jsc.updated_date < DATE_FORMAT(sysdate(),'%Y-%m-%d 00:00:00') AND jsc.state = 'DONE' AND jsc.project_code = 'C35052' AND wpj.project_code = 'C35052'
GROUP BY wpj.station_code,DATE_FORMAT(jsc.updated_date,'%Y-%m-%d %H:00:00')
...
SELECT 
 ...
 0 '平均两次任务间隔时长/秒'
  FROM evo_station.station_entry seq,
       ...
       WHERE @t < DATE_ADD(DATE_FORMAT(sysdate(),'%Y-%m-%d 00:00:00'),INTERVAL -1 HOUR)) tmp_line
  WHERE ((seq.entry_time >= DATE_ADD(DATE_FORMAT(sysdate(),'%Y-%m-%d 00:00:00'),INTERVAL -1 DAY) and seq.entry_time <= DATE_FORMAT(sysdate(),'%Y-%m-%d 00:00:00'))OR (seq.exit_time >= DATE_ADD(DATE_FORMAT(sysdate(),'%Y-%m-%d 00:00:00'),INTERVAL -1 DAY) and seq.exit_time <= DATE_FORMAT(sysdate(),'%Y-%m-%d 00:00:00')) OR (seq.entry_time <= DATE_ADD(DATE_FORMAT(sysdate(),'%Y-%m-%d 00:00:00'),INTERVAL -1 DAY) and seq.exit_time >= DATE_FORMAT(sysdate(),'%Y-%m-%d 00:00:00')))
  AND seq.biz_type = 'PUTAWAY_ONLINE_G2P_DIRECT_W2P' AND seq.project_code = 'C35052' 
GROUP BY tmp_line.ids,seq.station_code
)tt
GROUP BY tt.times,tt.station_code;
...
SELECT DATE_FORMAT(se.entry_time,'%Y-%m-%d %H:00:00') times,
     ...
     0 'time'
    FROM evo_station.station_entry se
	WHERE se.biz_type = 'CYCLECOUNT_ONLINE_G2P_W2P' and entry_time >= DATE_ADD(DATE_FORMAT(sysdate(),'%Y-%m-%d 00:00:00'),INTERVAL -1 DAY) AND entry_time < DATE_FORMAT(sysdate(),'%Y-%m-%d 00:00:00') AND se.project_code = 'C35052'
	GROUP BY DATE_FORMAT(se.entry_time,'%Y-%m-%d %H:00:00'),se.station_code
...
SELECT (@rn1:=@rn1+1) as rn1,se.station_code as station_code1,se.entry_time as entry_time1,se.exit_time as exit_time1
FROM evo_station.station_entry se,(SELECT @rn1:=0)rn
WHERE se.biz_type = 'CYCLECOUNT_ONLINE_G2P_W2P' AND se.project_code = 'C35052' AND se.entry_time >= DATE_ADD(DATE_FORMAT(sysdate(),'%Y-%m-%d 00:00:00'),INTERVAL -1 DAY) AND se.entry_time <= DATE_FORMAT(sysdate(),'%Y-%m-%d 00:00:00')
ORDER BY se.station_code,se.entry_time
)t1
JOIN
(
...
SELECT 
   ...
   0 'station_used',
    ...
    WHERE 
       ...
       AND sl.biz_type = 'CYCLECOUNT_ONLINE_G2P_W2P' AND sl.project_code = 'C35052' 
        ) tt1
    GROUP BY tt1.ida,tt1.station_code
