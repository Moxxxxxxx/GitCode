--涉及表 ods.ods_agv_breakdown_detail_dt、ods.ods_qkt_rcs_basic_agv、ods.ods_qkt_rcs_basic_agv_type、dim.dim_dsp_error_dict、dim_collection_project_record_ful、dwd_notification_message_info_di
...
where a.d='${pre1_date}' and upper(a.message_title) in ('RCS_RBTERR_UNKONW','RCS_RBTERR_NOTONCODE')
