...
COALESCE(t1.robot_error_time,0) as  robot_error_time,        -- 持续故障时长
COALESCE(t2.create_order_num,0) as create_order_num,         -- 新增订单量
COALESCE(t2.create_job_num,0) as create_job_num,            -- 新人任务量
COALESCE(t3.robot_run_time,0) as  robot_run_time           -- 理论运行时长
...
group by tb.robot_code)t1 on t1.robot_code=br.robot_code					
-- 所筛选小时内机器人新增
left join 
(select 
tocj.robot_code,
