...
null as sys_error_time,        -- 持续故障时长（去重）
null as create_order_num,      -- 新增订单量
null as create_job_num,        -- 新增任务量
null as sys_run_time           -- 理论运行时长
from 
(select id as error_id,start_time,end_time
...
union all 
select 
null as create_sys_error_num,  -- 新增故障次数
null as end_sys_error_num,     -- 结束故障次数
null as end_error_time,        -- 结束故障时间
null as sys_error_num,         -- 时间段内持续的故障次数
null as sys_error_time,        -- 持续故障时长（去重）
...
from 
(select hour_start_time ,sys_run_duration as theory_run_duration ,sys_error_duration as error_duration  
...
union all 
select 
hour_start_time,theory_run_duration,error_duration
from 
(select 
