...
select date(@now_start_time)               as                        date_value,
       t2.robot_code,
       t2.id              as                        state_id,
...
(
    ...
    `is_error`          bit(1)              DEFAULT NULL COMMENT '是否异常',
...
insert into qt_smartreport.qt_day_robot_state_detail_duration_his(date_value,robot_code,state_id,state_create_time,network_state,online_state,work_state,job_sn,cause,is_error,duration,stat_duration)	
...
insert into qt_smartreport.qt_hour_robot_state_detail_duration_his(date_value, robot_code, hour_start_time,
                                                                   ...
                                                                   cause, is_error,duration, stat_duration)
select date_add(current_date(), interval -1 day) as    date_value,
       t1.robot_code,
       t1.hour_start_time,
       t1.next_hour_start_time,
