...
####data1:qt_notification_system_module_p1_object_stat（包括当天数据）
...
####data2:qt_notification_system_module_p1_index_stat（包括当天数据）
...
from (select t1.notification_id,
             ...
             t1.server_code,
             t1.start_time
      from qt_smartreport.qt_notification_system_module_p1_time_hour_detail t1
      ...
      select t2.notification_id,
             ...
             t2.server_code,
             t2.start_time
      from qt_smartreport.qt_notification_system_module_p1_time_hour_detail_realtime t2
