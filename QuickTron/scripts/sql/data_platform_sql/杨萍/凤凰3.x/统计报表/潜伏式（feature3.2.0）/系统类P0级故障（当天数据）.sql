------------------------------------------------------------------------------------------------
--step1:建表（qt_notification_system_module_p0_time_hour_detail_realtime）
CREATE TABLE IF NOT EXISTS qt_smartreport.qt_notification_system_module_p0_time_hour_detail_realtime
(
    ...
    AUTO_INCREMENT = 1
    ROW_FORMAT = DYNAMIC COMMENT ='系统类P0级故障通知在小时内耗时明细（当天数据）';	




------------------------------------------------------------------------------------------------
--step2:删除当天相关数据（qt_notification_system_module_p0_time_hour_detail_realtime）
DELETE
...
------------------------------------------------------------------------------------------------
--step3:插入当天相关数据(qt_notification_system_module_p0_time_hour_detail_realtime)

insert into qt_smartreport.qt_notification_system_module_p0_time_hour_detail_realtime(hour_start_time,next_hour_start_time,notification_id,error_code,alarm_module,alarm_service,alarm_type,alarm_level,robot_code,first_classification_name,job_order,the_hour_order_seconds,device_code,server_code,object_code,object_type,start_time,end_time,the_hour_cost_seconds)
...
--------------------------------
##step4:建表(qt_notification_system_module_p0_object_stat_realtime)
CREATE TABLE IF NOT EXISTS qt_smartreport.qt_notification_system_module_p0_object_stat_realtime
(
    `id`                        int(20)   NOT NULL AUTO_INCREMENT COMMENT '主键',
    ...
    COLLATE = utf8_general_ci
    AUTO_INCREMENT = 1
    ROW_FORMAT = DYNAMIC COMMENT ='系统类P0告警通知在时间段内指标统计（当天数据）';	
	
	
--------------------------------
##step5:删除当天相关数据(qt_notification_system_module_p0_object_stat_realtime)
DELETE
...
--------------------------------
##step6-1:插入当天相关数据(qt_notification_system_module_p0_object_stat_realtime)
#time_type='小时'
#alarm_module = 'system' and alarm_type = 'robot'

insert into qt_smartreport.qt_notification_system_module_p0_object_stat_realtime(time_value, date_value, hour_value, object_code,object_type,first_classification_name,add_notification_num, notification_num,notification_time, notification_rate, notification_rate_fenzi,notification_rate_fenmu,mtbf,mtbf_fenzi,mtbf_fenmu, mttr,mttr_fenzi,mttr_fenmu, time_type)
...
from (select t1.hour_start_time,
      ...
      from (select h.hour_start_time,
         ...
         left join qt_smartreport.qt_notification_system_module_p0_time_hour_detail_realtime t
...
--------------------------------
##step6-2:插入当天相关数据(qt_notification_system_module_p0_object_stat_realtime)
#time_type='小时'
...
--------------------------------
##step6-3:插入当天相关数据(qt_notification_system_module_p0_object_stat_realtime)
#time_type='小时'
...
--------------------------------
##step6-4:插入当天相关数据(qt_notification_system_module_p0_object_stat_realtime)
#time_type='小时'
...
---------------------------------------------------------------------------------------
##step6-5:插入当天相关数据(qt_notification_system_module_p0_object_stat_realtime)
#time_type='天'
#alarm_module = 'system' and alarm_type = 'robot'
...
---------------------------------------------------------------------------------------
##step6-6:插入当天相关数据(qt_notification_system_module_p0_object_stat_realtime)
#time_type='天'
#alarm_module = 'system' and alarm_type = 'device'
...
------------------------------------------------------------
##step6-7:插入当天相关数据(qt_notification_system_module_p0_object_stat_realtime)
#time_type='天'
#alarm_module = 'system' and alarm_type = 'job'
...
-----------------------------------------------------------
##step6-8:插入当天相关数据(qt_notification_system_module_p0_object_stat_realtime)
#time_type='天'
#alarm_module = 'server' and alarm_service = 'SERVER'
...
------------------------------------------------------------------------------------------
--------------------------------
##step7:建表(qt_notification_system_module_p0_stat_realtime)
CREATE TABLE IF NOT EXISTS qt_smartreport.qt_notification_system_module_p0_stat_realtime
(
    `id`                         int(20)   NOT NULL AUTO_INCREMENT COMMENT '主键',
    `time_value`                 datetime  NOT NULL COMMENT '统计时间',
    `date_value`                 date               DEFAULT NULL COMMENT '日期',
    ...
    COLLATE = utf8_general_ci
    AUTO_INCREMENT = 1
    ROW_FORMAT = DYNAMIC COMMENT ='全场系统类P0级告警通知在时间段内指标统计（当天数据）';	
	
	
--------------------------------
##step8:删除当天相关数据(qt_notification_system_module_p0_stat_realtime)
DELETE
FROM qt_smartreport.qt_notification_system_module_p0_stat_realtime;  


--------------------------------
##step9-1:插入当天相关数据(qt_notification_system_module_p0_stat_realtime)
#time_type='小时'

insert into qt_smartreport.qt_notification_system_module_p0_stat_realtime(time_value, date_value, hour_value, object_num,robot_num, device_num, server_num, order_num,the_hour_order_seconds_sum, add_notification_num,notification_num, notification_time, notification_rate,notification_rate_fenzi,notification_rate_fenmu,mtbf,mtbf_fenzi,mtbf_fenmu, mttr,mttr_fenzi,mttr_fenmu, time_type)
...
------------------------------------------------------------------------------------------
##step9-2:插入当天相关数据(qt_notification_system_module_p0_stat_realtime)
#time_type='天'
...
##step10:建表(qt_notification_system_module_p0_index_stat_realtime)
CREATE TABLE IF NOT EXISTS qt_smartreport.qt_notification_system_module_p0_index_stat_realtime
(
    `id`                        int(20)   NOT NULL AUTO_INCREMENT COMMENT '主键',
    `time_value`                datetime  NOT NULL COMMENT '统计时间',
    `date_value`                date               DEFAULT NULL COMMENT '日期',
    ...
    COLLATE = utf8_general_ci
    AUTO_INCREMENT = 1
    ROW_FORMAT = DYNAMIC COMMENT ='全场系统类P0级告警通知在时间段内各指标值（当天数据）';	
	
	
--------------------------------
##step11:删除数据(qt_notification_system_module_p0_index_stat_realtime)
DELETE
FROM qt_smartreport.qt_notification_system_module_p0_index_stat_realtime;   
	

--------------------------------
##step12:插入当天相关数据(qt_notification_system_module_p0_index_stat_realtime)

insert into qt_smartreport.qt_notification_system_module_p0_index_stat_realtime(time_value, date_value, hour_value, time_type,index_value,index_value_fenzi,index_value_fenmu, value_type)
