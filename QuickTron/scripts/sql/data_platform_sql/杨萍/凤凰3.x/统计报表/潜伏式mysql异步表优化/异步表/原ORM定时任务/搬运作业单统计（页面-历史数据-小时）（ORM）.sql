-- 表1：qt_smartreport.qtr_hour_transport_order_link_detail_his

-- step1:删除相关数据（qtr_hour_transport_order_link_detail_his）
DELETE
FROM qt_smartreport.qtr_hour_transport_order_link_detail_his
where hour_start_time=date_format(DATE_ADD(sysdate(), INTERVAL -1 HOUR), '%Y-%m-%d %H:00:00');	


-- step2:插入相关数据（qtr_hour_transport_order_link_detail_his）
...
-- 备注：老表数据同步
TRUNCATE TABLE qt_smartreport.qtr_hour_transport_order_link_detail_his;
insert into qt_smartreport.qtr_hour_transport_order_link_detail_his(create_time,update_time,date_value,hour_start_time,next_hour_start_time,link_id, upstream_order_no, order_no,link_create_time,event_time, execute_state, order_state,robot_code, first_classification,robot_type_code,robot_type_name,cost_time)
select created_time as create_time,updated_time as update_time,date_value,hour_start_time,next_hour_start_time,link_id, upstream_order_no, order_no,link_create_time,event_time, execute_state, order_state,robot_code, first_classification,null as robot_type_code,robot_type_name,cost_time
from qt_smartreport.qt_hour_transport_order_link_detail_his;



--------------------------------------------------------------------------------
-- 表2：qt_smartreport.qtr_hour_transport_order_detail_his

-- step1:删除相关数据（qtr_hour_transport_order_detail_his）
DELETE
FROM qt_smartreport.qtr_hour_transport_order_detail_his
where hour_start_time=date_format(DATE_ADD(sysdate(), INTERVAL -1 HOUR), '%Y-%m-%d %H:00:00');	



-- step2:插入相关数据（qtr_hour_transport_order_detail_his）
...
-- 备注：老表数据同步
TRUNCATE TABLE qt_smartreport.qtr_hour_transport_order_detail_his;
insert into qt_smartreport.qtr_hour_transport_order_detail_his(create_time,update_time,date_value, hour_start_time,next_hour_start_time,upstream_order_no, order_no, scene_type,start_point,start_area,target_point, target_area, order_state,
...
select created_time as create_time,updated_time as update_time,date_value,hour_start_time,next_hour_start_time, upstream_order_no, order_no, scene_type,start_point,start_area,target_point, target_area, order_state,
dispatch_robot_code_num, dispatch_robot_code_str,dispatch_robot_classification_str, total_time_consuming,
empty_move_distance, empty_move_speed,loading_move_distance,loading_move_speed, waiting_robot_time_consuming,move_time_consuming, lift_up_time_consuming,rack_move_time_consuming, put_down_time_consuming,guide_time_consuming, robot_rotate_num, order_create_time,order_completed_time
...
--------------------------------------------------------------------------------
-- 表3：qt_smartreport.qtr_hour_transport_upstream_order_detail_his

-- step1:删除相关数据（qtr_hour_transport_upstream_order_detail_his）
DELETE
FROM qt_smartreport.qtr_hour_transport_upstream_order_detail_his
where hour_start_time=date_format(DATE_ADD(sysdate(), INTERVAL -1 HOUR), '%Y-%m-%d %H:00:00');	


-- step2:插入相关数据（qtr_hour_transport_upstream_order_detail_his）
insert into qt_smartreport.qtr_hour_transport_upstream_order_detail_his(create_time,update_time,date_value, hour_start_time,next_hour_start_time,upstream_order_no, scene_type,start_point, start_area, target_point,target_area,upstream_order_state, dispatch_robot_code_num,dispatch_robot_code_str,dispatch_robot_classification_str,total_time_consuming, empty_move_distance,empty_move_speed,loading_move_distance,loading_move_speed, waiting_robot_time_consuming,move_time_consuming, lift_up_time_consuming,rack_move_time_consuming,put_down_time_consuming,guide_time_consuming, robot_rotate_num,dispatch_order_no,dispatch_order_num,upstream_order_create_time,upstream_order_completed_time)
select 
CURRENT_TIMESTAMP as create_time,
CURRENT_TIMESTAMP as update_time, 
date(DATE_ADD(sysdate(), INTERVAL -1 HOUR)) as date_value,
...
-- 备注：老表数据同步
TRUNCATE TABLE qt_smartreport.qtr_hour_transport_upstream_order_detail_his;
insert into qt_smartreport.qtr_hour_transport_upstream_order_detail_his(create_time,update_time,date_value, hour_start_time,next_hour_start_time,upstream_order_no, scene_type,start_point, start_area, target_point,target_area,upstream_order_state, dispatch_robot_code_num,dispatch_robot_code_str,dispatch_robot_classification_str,total_time_consuming, empty_move_distance,empty_move_speed,loading_move_distance,loading_move_speed, waiting_robot_time_consuming,move_time_consuming, lift_up_time_consuming,rack_move_time_consuming,put_down_time_consuming,guide_time_consuming, robot_rotate_num,dispatch_order_no,dispatch_order_num,upstream_order_create_time,upstream_order_completed_time)
select created_time as create_time,updated_time as update_time,date_value, hour_start_time,next_hour_start_time,upstream_order_no, scene_type,start_point, start_area, target_point,target_area,upstream_order_state, dispatch_robot_code_num,dispatch_robot_code_str,dispatch_robot_classification_str,total_time_consuming, empty_move_distance,empty_move_speed,loading_move_distance,loading_move_speed, waiting_robot_time_consuming,move_time_consuming, lift_up_time_consuming,rack_move_time_consuming,put_down_time_consuming,guide_time_consuming, robot_rotate_num,dispatch_order_no,dispatch_order_num,upstream_order_create_time,upstream_order_completed_time
