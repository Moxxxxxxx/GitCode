...
t1.start_time,
	   ...
	   case when t1.end_time is null or t1.end_time >= @dt_next_hour_start_time then @dt_next_hour_start_time else t1.end_time end as stat_end_time
from (select *
...
-- 插入数据（异步表）qt_smartreport.qtr_hour_robot_error_list_his	
-- {{ dt_relative_time(dt) }}
-- {{ now_time }}
-- {{ dt_hour_start_time }}
