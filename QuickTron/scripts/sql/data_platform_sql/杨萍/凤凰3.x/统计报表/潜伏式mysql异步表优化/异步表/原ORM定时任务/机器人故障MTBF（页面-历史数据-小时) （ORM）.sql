-- 表1：qt_smartreport.qtr_hour_robot_error_list_his


-- step1:删除相关数据（qtr_hour_robot_error_list_his）
DELETE
...
-- step2:插入相关数据（qtr_hour_robot_error_list_his）
insert into qt_smartreport.qtr_hour_robot_error_list_his(create_time,update_time,date_value,hour_start_time,next_hour_start_time, error_id, error_code, start_time, end_time,warning_spec,alarm_module,alarm_service,alarm_type,alarm_level,alarm_detail,param_value,job_order,robot_job,robot_code,device_code,server_code,transport_object,stat_start_time,stat_end_time)
select 
...
-- 备注：老表数据同步
TRUNCATE TABLE qt_smartreport.qtr_hour_robot_error_list_his;
insert into qt_smartreport.qtr_hour_robot_error_list_his(create_time,update_time,date_value,hour_start_time,next_hour_start_time, error_id, error_code, start_time, end_time,warning_spec,alarm_module,alarm_service,alarm_type,alarm_level,alarm_detail,param_value,job_order,robot_job,robot_code,device_code,server_code,transport_object,stat_start_time,stat_end_time)
select created_time as create_time,updated_time as update_time,date_value,hour_start_time,next_hour_start_time, error_id, error_code, start_time, end_time,warning_spec,alarm_module,alarm_service,alarm_type,alarm_level,alarm_detail,param_value,job_order,robot_job,robot_code,device_code,server_code,transport_object,stat_start_time,stat_end_time
...
--------------------------------------------------------------------------------
-- 表2：qt_smartreport.qtr_hour_robot_error_mtbf_his


-- step1:删除相关数据（qtr_hour_robot_error_mtbf_his）
DELETE
...
-- step2:插入相关数据（qtr_hour_robot_error_mtbf_his）
insert into qt_smartreport.qtr_hour_robot_error_mtbf_his(create_time,update_time,date_value,hour_start_time,next_hour_start_time,robot_code,theory_run_duration,error_duration,error_num,mtbf,accum_theory_run_duration,accum_error_duration,accum_error_num,accum_mtbf)
select 
CURRENT_TIMESTAMP as create_time,
CURRENT_TIMESTAMP as update_time,
date(DATE_ADD(sysdate(), INTERVAL -1 HOUR)) as date_value,
...
-- 备注：老表数据同步
TRUNCATE TABLE qt_smartreport.qtr_hour_robot_error_mtbf_his;
insert into qt_smartreport.qtr_hour_robot_error_mtbf_his(create_time,update_time,date_value,hour_start_time,next_hour_start_time,robot_code,theory_run_duration,error_duration,error_num,mtbf,accum_theory_run_duration,accum_error_duration,accum_error_num,accum_mtbf)
select created_time as create_time,updated_time as update_time,date_value,hour_start_time,next_hour_start_time,robot_code,theory_run_duration,error_duration,error_num,mtbf,accum_theory_run_duration,accum_error_duration,accum_error_num,accum_mtbf
