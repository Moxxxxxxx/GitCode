...
-- 插入数据（mysql参数）
-- insert into qt_smartreport.qtr_hour_action_terminal_guide_operation_his(create_time,update_time,date_value,hour_start_time,next_hour_start_time,action_uid,action_begin_time,action_end_time,robot_code,job_sn,action_code,is_loading,terminal_guide_start_time,terminal_guide_end_time,terminal_guide_cost_time)
...
-- 插入数据（异步表）qt_smartreport.qtr_hour_action_terminal_guide_operation_his	
-- {{ dt_relative_time(dt) }}
-- {{ now_time }}
-- {{ dt_hour_start_time }}
