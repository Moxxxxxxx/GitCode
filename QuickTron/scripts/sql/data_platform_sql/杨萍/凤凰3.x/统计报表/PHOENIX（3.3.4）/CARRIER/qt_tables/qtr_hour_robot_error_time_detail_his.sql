...
left join phoenix_basic.basic_error_info t3 on t3.error_code =t2.error_code
...
left join phoenix_basic.dbo.basic_error_info t3 on t3.error_code =t2.error_code
