...
-------------------------------------------------------------------------------------------------------------00
-- 凤凰搬运作业单分析统计 ads_phx_carry_work_analyse_count 

-- 凤凰3.X CARRIER逻辑  
INSERT overwrite table ${ads_dbname}.ads_phx_carry_work_analyse_count partition (d, pt)
SELECT ''                                                      as id,                        -- 主键
       ...
       nvl(td.move_cost / 1000, 0)       as robot_move_duration,       -- 搬运耗时
       NULL                                                    as station_executor_duration, -- 进站实操耗时
       td.order_create_time                                    as work_create_time,          -- 作业单创建时间
       td.order_update_time                                    as work_complete_time,        -- 作业单完成时间
