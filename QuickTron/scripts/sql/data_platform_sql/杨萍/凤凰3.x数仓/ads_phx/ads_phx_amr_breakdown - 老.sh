...
-------------------------------------------------------------------------------------------------------------00
-- 凤凰机器人故障统计 ads_phx_amr_breakdown 
...
SELECT 
'' as id, -- 主键
date_format( rl.cur_hour,'yyyy-MM-dd HH:00:00') as data_time, -- 统计小时
...
$hive -e "$sql" && hive_concatenate ads ads_phx_amr_breakdown ${pre1_date}
