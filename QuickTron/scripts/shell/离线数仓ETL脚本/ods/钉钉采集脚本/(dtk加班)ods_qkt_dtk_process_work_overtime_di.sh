...
#-- 功能描述 ： 采集钉钉加班审批信息记录
#-- 注意 ： 每天增量，每天一个增量分区
#-- 输入表 : quality_data.dingtalk_process_work_overtime
#-- 输出表 ：ods.ods_qkt_dtk_process_work_overtime_di
...
######### 设置表的变量
ods_dbname=ods
table=ods_qkt_dtk_process_work_overtime_di
outdir=/data/sqoop/logs/hcatalog
target_dir=/warehouse/hive/ods/
mysql_dbname=quality_data
mysql_table=dingtalk_process_work_overtime
