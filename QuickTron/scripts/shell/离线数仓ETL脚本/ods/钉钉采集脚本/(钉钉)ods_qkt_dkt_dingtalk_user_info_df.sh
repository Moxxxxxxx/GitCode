...
#-- 输出表 ：ods.ods_qkt_dkt_dingtalk_user_info_df
...
######### 设置表的变量
dbname=ods
table=ods_qkt_dkt_dingtalk_user_info_df
...
--query "select
union_id, open_id, remark, user_id, is_boss, hired_date, tel, department, work_place, email, order_code, is_leader, mobile, active, is_admin, avatar, is_hide, job_number, name, extattr, state_code, \`position\`, create_time, update_time
