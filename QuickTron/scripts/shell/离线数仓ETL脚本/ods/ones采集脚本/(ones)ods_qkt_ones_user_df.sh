...
#-- 功能描述 ： 采集ones  用户表
#-- 注意 ： 每天全量，每天一个快照
#-- 输入表 : quality_data.user
#-- 输出表 ：ods.ods_qkt_ones_user_df
...
--query "select
uuid, email, create_time, status, verify_status, name, avatar, phone, channel, password, access_time, sync_id, company, id_number
