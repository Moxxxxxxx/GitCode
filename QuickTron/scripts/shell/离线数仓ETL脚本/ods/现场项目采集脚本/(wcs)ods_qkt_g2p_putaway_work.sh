...
######### 设置表的变量
dbname=ods
table=ods_qkt_g2p_putaway_work
outdir=/data/sqoop/logs/hcatalog
target_dir=/warehouse/hive/ods/
mysql_dbname=evo_wcs_g2p
mysql_table=putaway_work
...
###################### putaway_work->ods_qkt_g2p_putaway_work(T-1每日全量->分区)
...
## 参数
columns=id,warehouse_id,zone_code,work_id,order_id,source_order_type,buckets,owner_code,tenant_id,state,station_code,created_app,created_date,updated_app,updated_date,project_code
