...
######### 设置表的变量
dbname=ods
table=ods_qkt_rcs_basic_charger
...
###################### basic_charger->ods_qkt_rcs_basic_charger(T-1每日全量->分区)
...
use $dbname;
insert overwrite table dwd.dwd_rcs_basic_charger_info partition(d,pt)
select 
id,
warehouse_id,
charger_code,
