...
######### 设置表的变量
dbname=ods
table=ods_qkt_station_station_point
outdir=/data/sqoop/logs/hcatalog
target_dir=/warehouse/hive/ods/
mysql_dbname=evo_station
mysql_table=station_point
...
###################### station_point->ods_qkt_station_station_point(T-1每日全量->分区)
...
use $dbname;
insert overwrite table dwd.dwd_station_station_point_info partition(d,pt)
select 
id,
warehouse_id,
station_id,
