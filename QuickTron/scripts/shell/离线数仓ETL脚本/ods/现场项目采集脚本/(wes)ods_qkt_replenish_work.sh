...
######### 设置表的变量
dbname=ods
table=ods_qkt_replenish_work
outdir=/data/sqoop/logs/hcatalog
target_dir=/warehouse/hive/ods/
mysql_dbname=evo_wes_replenish
mysql_table=replenish_work
...
###################### replenish_work->ods_qkt_replenish_work(T-1每日增量量->分区)
...
## 参数
columns=id,replenish_work_number,tenant_id,owner_code,work_type,state,priority_type,priority_value,station_id,station_code,done_date,done_user,source_order_type,source_order_id,replenish_mode,opened,submit_times,remark,version,zone_id,zone_code,warehouse_id,delete_flag,udf1,udf2,udf3,udf4,udf5,created_date,created_user,created_app,last_updated_date,last_updated_user,last_updated_app,project_code
### 第一次初始化脚本
init_sql="
