...
######### 设置表的变量
dbname=ods
table=ods_qkt_g2p_w2p_countcheck_job
outdir=/data/sqoop/logs/hcatalog
target_dir=/warehouse/hive/ods/
mysql_dbname=evo_wcs_g2p
mysql_table=w2p_countcheck_job_v2
...
## 参数
columns=id,warehouse_id,zone_code,job_id,job_type,state,agv_code,agv_type,priority,work_id,detail_id,station_code,container_code,bucket_code,bucket_slot_code,source_way_point_code,station_waypoint_code,target_waypoint_code,level3_inventory_id,container_transfer_job_id,container_move_job_id,created_app,created_date,updated_app,updated_date,project_code
