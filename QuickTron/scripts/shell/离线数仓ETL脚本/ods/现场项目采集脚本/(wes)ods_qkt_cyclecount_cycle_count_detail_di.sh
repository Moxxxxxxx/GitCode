...
## 参数
columns=id,warehouse_id,cycle_count_id,level3_inventory_id,inventory_profit_version,owner_code,sku_id,lot_id,pack_id,level1_container_code,level2_container_code,frozen_flag,version,station_code,zone_code,bucket_code,bucket_slot_code,bucket_face,quantity,runtime_quantity,actual_quantity,diff_quantity,diff_reason,remark,delete_flag,operator,created_date,created_user,created_app,last_updated_date,last_updated_user,last_updated_app,project_code
### 第一次初始化脚本
init_sql="
