...
######### 设置表的变量
dbname=ods
table=ods_qkt_g2p_guided_putaway_work_detail
outdir=/data/sqoop/logs/hcatalog
target_dir=/warehouse/hive/ods/
mysql_dbname=evo_wcs_g2p
mysql_table=guided_putaway_work_detail
...
###################### guided_putaway_work_detail->ods_qkt_g2p_guided_putaway_work_detail(T-1每日全量->分区)
