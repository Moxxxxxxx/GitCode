...
######### 设置表的变量
dbname=ods
table=ods_qkt_g2p_guided_putaway_work
outdir=/data/sqoop/logs/hcatalog
target_dir=/warehouse/hive/ods/
mysql_dbname=evo_wcs_g2p
mysql_table=guided_putaway_work
...
###################### guided_putaway_work->ods_qkt_g2p_guided_putaway_work(T-1每日全量->分区)
...
## 参数
columns=id,warehouse_id,zone_code,work_id,order_id,state,biz_class,biz_type,package_type,priority,finished_date,stop_date,cancel_date,created_app,created_date,updated_app,updated_date,opened,submit_times,project_code
### 第一次初始化脚本
init_sql="
