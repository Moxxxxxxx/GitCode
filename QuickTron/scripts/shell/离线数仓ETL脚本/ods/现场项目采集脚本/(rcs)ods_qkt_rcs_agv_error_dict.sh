...
######### 设置表的变量
dbname=ods
table=ods_qkt_rcs_agv_error_dict
outdir=/data/sqoop/logs/hcatalog
target_dir=/warehouse/hive/ods/
mysql_dbname=evo_rcs
mysql_table=rcs_agv_error_dict
incre_column=gmt_create
...
######################  rcs_agv_error_dict->ods_qkt_rcs_agv_error_dict(T-1每日全量->分区)
...
use $dbname;
insert overwrite table dwd.dwd_rcs_agv_error_dict_info partition(d,pt)
select 
id,
error_domain,
error_type,
