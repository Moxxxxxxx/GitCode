...
######### 设置表的变量
dbname=ods
table=ods_qkt_rcs_agv_history_job
outdir=/data/sqoop/logs/hcatalog
target_dir=/warehouse/hive/ods/
mysql_dbname=evo_rcs
mysql_table=rcs_agv_history_job
...
###################### rcs_agv_history_job->ods_qkt_rcs_agv_history_job(T-1每日增量量->分区)
...
## 参数
columns=id,agv_id,bucket_id,bucket_pointcode,dest_pointcode,gmt_create,gmt_create_user,gmt_modified,gmt_modified_user,job_id,job_mark,job_priority,job_state,job_type,let_down,own_job_type,top_face,warehouse_id,action_point_code,action_state,can_interrupt,is_report_event,job_context,src_job_type,project_code
### 第一次初始化脚本
init_sql="
