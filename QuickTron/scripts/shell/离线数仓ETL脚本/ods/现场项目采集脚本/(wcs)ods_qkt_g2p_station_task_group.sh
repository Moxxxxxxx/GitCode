...
######### 设置表的变量
dbname=ods
table=ods_qkt_g2p_station_task_group
outdir=/data/sqoop/logs/hcatalog
target_dir=/warehouse/hive/ods/
mysql_dbname=evo_wcs_g2p
mysql_table=station_task_group
...
###################### station_task_group->ods_qkt_g2p_station_task_group(T-1每日增量->分区)
...
## 参数
columns=id,warehouse_id,zone_code,group_job_id,job_id,job_type,created_app,created_date,updated_app,updated_date,project_code
