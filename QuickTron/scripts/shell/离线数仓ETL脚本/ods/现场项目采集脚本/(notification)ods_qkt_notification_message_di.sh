...
## 参数
columns=id,unit_id,message_id,unit_type,warning_type,title,service_name,read_status,status,event,notify_level,happen_at,close_at,message_body,compress_message_body,warehouse_id,created_user,created_app,created_time,last_updated_user,last_updated_app,last_updated_time,project_code
### 第一次初始化脚本
init_sql="
