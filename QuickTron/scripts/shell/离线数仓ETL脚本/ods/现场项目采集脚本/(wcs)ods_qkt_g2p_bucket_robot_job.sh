...
######### 设置表的变量
dbname=ods
table=ods_qkt_g2p_bucket_robot_job
...
## 参数
columns=id,warehouse_id,zone_code,job_id,robot_job_id,priority_type,priority,bucket_code,state,source,work_mode,push_flag,bucket_slot_code,target_bucket_slot_code,start_point,start_point_name,work_face,work_faces,end_area,target_point,target_point_name,agv_end_point,put_down,need_operation,need_reset,lock_flag,bucket_type_code,need_out,check_code,stand_by_flag,job_type,up_job_type,dispatch_state,remark,agv_code,agv_type,business_type,device_code,cancel_strategy,deadline,busi_group_id,robot_job_group_id,sequence,flag,created_app,created_date,updated_app,updated_date,hds_group_id,bucket_type,start_area,project_code
### 第一次初始化脚本
init_sql="
