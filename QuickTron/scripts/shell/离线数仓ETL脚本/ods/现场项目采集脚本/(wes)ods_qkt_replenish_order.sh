...
###################### replenish_order->ods_qkt_replenish_order(T-1每日增量量->分区)
...
use $dbname;
insert overwrite table dwd.dwd_replenish_order_info partition(d,pt)
select 
id,
replenish_order_number,
sn_unique_assist_key,
