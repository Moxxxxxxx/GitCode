...
######### 设置表的变量
dbname=ods
table=ods_qkt_inventory_transaction
...
###################### inventory_transaction->ods_qkt_inventory_transaction(T-1每日增量->分区)
