...
######### 设置表的变量
dbname=ods
table=ods_qkt_g2p_countcheck_job
outdir=/data/sqoop/logs/hcatalog
target_dir=/warehouse/hive/ods/
mysql_dbname=evo_wcs_g2p
mysql_table=countcheck_job
...
###################### countcheck_job->ods_qkt_g2p_countcheck_job(T-1每日增量->分区)
...
--query "select id ,warehouse_id ,zone_code ,job_id ,job_type ,state ,agv_code ,agv_type ,priority,detail_id ,work_id ,station_code ,bucket_code ,source_waypoint_code ,target_waypoint_code ,bucket_face_num ,bucket_init_face ,bucket_target_face
,bucket_move_job_id ,created_app ,created_date 
,updated_app ,updated_date,project_code  from $mysql_table  
