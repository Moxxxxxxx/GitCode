...
######### 设置表的变量
dbname=ods
table=ods_qkt_g2p_w2p_guided_putaway_work_detail
outdir=/data/sqoop/logs/hcatalog
target_dir=/warehouse/hive/ods/
mysql_dbname=evo_wcs_g2p
mysql_table=w2p_guided_putaway_work_detail
...
###################### w2p_guided_putaway_work_detail->ods_qkt_g2p_w2p_guided_putaway_work_detail(T-1每日全量->分区)
...
## 参数
columns=id,warehouse_id,zone_code,work_id,detail_id,sku_id,owner_code,lot_id,pack_id,original_quantity,quantity,fulfill_quantity,frozen,level3_inventory_id,created_app,created_date,updated_app,updated_date,project_code
### 第一次初始化脚本
init_sql="
