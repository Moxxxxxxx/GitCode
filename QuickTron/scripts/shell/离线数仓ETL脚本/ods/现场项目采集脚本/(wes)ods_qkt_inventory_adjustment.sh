...
######### 设置表的变量
dbname=ods
table=ods_qkt_inventory_adjustment
outdir=/data/sqoop/logs/hcatalog
target_dir=/warehouse/hive/ods/
mysql_dbname=evo_wes_inventory
mysql_table=inventory_adjustment
...
###################### inventory_adjustment->ods_qkt_inventory_adjustment(T-1每日增量->分区)
...
## 参数
columns=id,warehouse_id,adjustment_number,external_id,adjustment_type,source_bill_no,state,remark,version,delete_flag,created_date,created_user,created_app,last_updated_date,last_updated_user,last_updated_app,project_code
### 第一次初始化脚本
init_sql="
