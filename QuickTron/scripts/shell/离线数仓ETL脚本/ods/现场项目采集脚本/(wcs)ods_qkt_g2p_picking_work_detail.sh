...
######### 设置表的变量
dbname=ods
table=ods_qkt_g2p_picking_work_detail
...
###################### picking_work_detail->ods_qkt_g2p_picking_work_detail(T-1每日增量->分区)
...
## 参数
columns=id,warehouse_id,zone_code,picking_work_detail_id,picking_order_detail_id,picking_work_id,level3_inventory_id,sku_id,lot_id,pack_id,owner_code,frozen,quantity,fulfill_quantity,created_app,created_date,updated_app,updated_date,project_code
