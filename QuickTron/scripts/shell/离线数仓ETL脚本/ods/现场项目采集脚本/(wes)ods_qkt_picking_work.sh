...
######### 设置表的变量
dbname=ods
table=ods_qkt_picking_work
outdir=/data/sqoop/logs/hcatalog
target_dir=/warehouse/hive/ods/
mysql_dbname=evo_wes_picking
mysql_table=picking_work
...
###################### picking_work->ods_qkt_picking_work(T-1每日增量量->分区)
