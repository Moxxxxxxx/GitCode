...
######### 设置表的变量
dbname=ods
table=ods_qkt_g2p_w2p_putaway_job
outdir=/data/sqoop/logs/hcatalog
target_dir=/warehouse/hive/ods/
mysql_dbname=evo_wcs_g2p
mysql_table=w2p_putaway_job_v2
...
###################### w2p_putaway_job_v2->ods_qkt_g2p_w2p_putaway_job(T-1每日增量->分区)
...
## 参数
columns=id,warehouse_id,zone_code,job_id,job_type,priority,priority_type,state,agv_code,agv_type,station_code,put_away_work_id,container_code,source_way_point_code,station_way_point_code,container_move_job_id,created_app,created_date,updated_app,updated_date,project_code
### 第一次初始化脚本
init_sql="
