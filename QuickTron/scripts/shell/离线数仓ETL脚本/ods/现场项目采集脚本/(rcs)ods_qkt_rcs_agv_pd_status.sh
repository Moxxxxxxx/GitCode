...
######### 设置表的变量
dbname=ods
table=ods_qkt_rcs_agv_pd_status
outdir=/data/sqoop/logs/hcatalog
target_dir=/warehouse/hive/ods/
mysql_dbname=evo_rcs
mysql_table=agv_pd_status
incre_column_1=modified_date
...
###################### agv_pd_status->ods_qkt_rcs_agv_pd_status(T-1每日增量量->分区)
...
## 参数
columns=id,create_time,update_time,agv_code,agv_id,agv_mac_address,ap_mac_address,ap_radio_id,ap_service_id,battery_temperature,bucket_heading,bucket_id,direction,disk_space_percent,exception_code,ground_code_bias,ground_decoded,is_barrier,is_return_home,liftup_number,load_mileage,loading_bucket,no_load_mileage,over_all_mileage,point_code,power,robot_state,signal_strength,speed,warehouse_id,x,y,create_date,create_user,gmt_create,gmt_create_user,gmt_modified,gmt_modified_user,gyro_temperature,layerelectric_temperature,leftelectric_temperature,rightelectric_temperature,liftelectric_temperature,modified_date,modified_user,waypoint_id,project_code
### 第一次初始化脚本
init_sql="
