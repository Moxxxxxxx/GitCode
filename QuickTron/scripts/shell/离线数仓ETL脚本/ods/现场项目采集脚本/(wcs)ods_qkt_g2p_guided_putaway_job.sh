...
######### 设置表的变量
dbname=ods
table=ods_qkt_g2p_guided_putaway_job
outdir=/data/sqoop/logs/hcatalog
target_dir=/warehouse/hive/ods/
mysql_dbname=evo_wcs_g2p
mysql_table=guided_put_away_job
...
###################### guided_put_away_job->ods_qkt_g2p_guided_putaway_job(T-1每日全量->分区)
