...
######### 设置表的变量
dbname=ods
table=ods_qkt_g2p_w2p_putaway_work
outdir=/data/sqoop/logs/hcatalog
target_dir=/warehouse/hive/ods/
mysql_dbname=evo_wcs_g2p
mysql_table=w2p_putaway_work_v2
...
###################### w2p_putaway_work_v2->ods_qkt_g2p_w2p_putaway_work(T-1每日增量->分区)
...
## 参数
columns=id,warehouse_id,zone_code,work_id,priority,priority_type,state,station_code,created_app,created_date,updated_app,updated_date,project_code
### 第一次初始化脚本
init_sql="
