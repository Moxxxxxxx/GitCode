...
######### 设置表的变量
dbname=ods
table=ods_qkt_rcs_basic_area
outdir=/data/sqoop/logs/hcatalog
target_dir=/warehouse/hive/ods/
mysql_dbname=evo_rcs
mysql_table=basic_area
...
###################### basic_area->ods_qkt_rcs_basic_area(T-1每日全量->分区)
...
use $dbname;
insert overwrite table dwd.dwd_rcs_basic_area_info partition(d,pt)
select 
id,
area_code,
warehouse_id,
