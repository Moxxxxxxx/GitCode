...
######### 设置表的变量
dbname=ods
table=ods_qkt_rcs_basic_agv_type
...
###################### basic_agv_type->ods_qkt_rcs_basic_agv_type(T-1每日全量->分区)
...
use $dbname;
insert overwrite table dwd.dwd_rcs_basic_agv_type_info partition(d,pt)
select 
id,
warehouse_id,
agv_type_code,
