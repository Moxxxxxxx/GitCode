...
######### 设置表的变量
dbname=ods
table=ods_qkt_g2p_work_binding_station
outdir=/data/sqoop/logs/hcatalog
target_dir=/warehouse/hive/ods/
mysql_dbname=evo_wcs_g2p
mysql_table=work_binding_station
...
###################### work_binding_station->ods_wcs_g2p_work_binding_station(T-1每日全量->分区)
...
--query "select id,warehouse_id,work_id,biz_type,work_mode,enabled,station_code,created_app,created_date,updated_app,updated_date,project_code from $mysql_table  
...
## 参数
columns=id,warehouse_id,work_id,biz_type,work_mode,enabled,station_code,created_app,created_date,updated_app,updated_date,project_code
...
use $dbname;
insert overwrite table dwd.dwd_g2p_work_binding_station_info partition(d,pt)
select 
id ,
warehouse_id ,
work_id,
...
from ods_qkt_g2p_work_binding_station
