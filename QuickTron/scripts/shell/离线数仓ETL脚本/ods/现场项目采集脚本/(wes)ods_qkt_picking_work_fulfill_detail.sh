...
######### 设置表的变量
dbname=ods
table=ods_qkt_picking_work_fulfill_detail
...
###################### picking_work_fulfill_detail->ods_qkt_picking_work_fulfill_detail(T-1每日增量量->分区)
...
## 参数
columns=id,picking_work_detail_id,tenant_id,state,sku_id,owner_code,work_id,pack_id,lot_id,station_slot_id,station_slot_code,station_code,quantity,short_pick,container_code,package_uuid,level3_inventory_id,bucket_code,bucket_slot_code,job_id,short_pick_flag,short_pick_reason,location_container_code,version,operator,warehouse_id,delete_flag,created_date,created_user,created_app,last_updated_date,last_updated_user,last_updated_app,frozen_flag,project_code
### 第一次初始化脚本
init_sql="
