...
######### 设置表的变量
dbname=ods
table=ods_qkt_g2p_bucket_move_job
...
###################### bucket_move_job->ods_qkt_g2p_bucket_move_job(T-1每日增量->分区)
...
## 参数
columns=id,warehouse_id,zone_code,job_id,lift_group_id,busi_group_id,left_group_id,\`floor\`,job_type,state,\`source\`,agv_code,agv_type,priority_type,priority,bucket_move_type,bucket_code,station_code,source_waypoint_code,target_waypoint_code,top_face,bucket_face_num,put_down,need_operation,agv_end_point,lock_flag,bucket_type_code,check_code,stand_by_flag,created_app,created_date,updated_app,updated_date,flag,project_code
