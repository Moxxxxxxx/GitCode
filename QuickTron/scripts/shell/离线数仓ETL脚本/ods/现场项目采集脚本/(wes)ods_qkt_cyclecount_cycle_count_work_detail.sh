...
######### 设置表的变量
dbname=ods
table=ods_qkt_cyclecount_cycle_count_work_detail
outdir=/data/sqoop/logs/hcatalog
target_dir=/warehouse/hive/ods/
mysql_dbname=evo_wes_cyclecount
mysql_table=cycle_count_work_detail
...
###################### cycle_count_work_detail->ods_qkt_cyclecount_cycle_count_work_detail(T-1每日增量->分区)
...
## 参数
columns=id,warehouse_id,cycle_count_work_id,owner_code,bucket_code,bucket_face,state,level1_container_code,level2_container_code,version,created_date,created_user,created_app,last_updated_date,last_updated_user,last_updated_app,project_code
### 第一次初始化脚本
init_sql="
