...
######### 设置表的变量
dbname=ods
table=ods_qkt_picking_order_state_change
outdir=/data/sqoop/logs/hcatalog
target_dir=/warehouse/hive/ods/
mysql_dbname=evo_wes_picking
mysql_table=picking_order_state_change
...
###################### picking_order_state_change->ods_qkt_picking_order_state_change(T-1每日增量量->分区)
...
## 参数
columns=id,picking_order_id,tenant_id,state,version,zone_id,warehouse_id,delete_flag,created_date,created_user,created_app,last_updated_date,last_updated_user,last_updated_app,project_code
