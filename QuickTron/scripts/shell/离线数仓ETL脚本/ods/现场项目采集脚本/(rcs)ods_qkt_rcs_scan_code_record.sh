...
######### 设置表的变量
dbname=ods
table=ods_qkt_rcs_scan_code_record
outdir=/data/sqoop/logs/hcatalog
target_dir=/warehouse/hive/ods/
mysql_dbname=evo_rcs
mysql_table=rcs_scan_code_record
incre_column=date_created
...
###################### rcs_scan_code_record->ods_qkt_rcs_scan_code_record(T-1每日增量->分区)
...
## 参数
columns=id,agv_code,barcode_decoded,barcode_in_map,bias_type,date_created,direction,job_id,point_code,point_x,point_y,project_code
