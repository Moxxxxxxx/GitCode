...
######### 设置表的变量
dbname=ods
table=ods_qkt_g2p_putaway_work_detail
outdir=/data/sqoop/logs/hcatalog
target_dir=/warehouse/hive/ods/
mysql_dbname=evo_wcs_g2p
mysql_table=putaway_work_detail
...
###################### putaway_work_detail->ods_qkt_g2p_putaway_work_detail(T-1每日增量->分区)
...
## 参数
columns=id,warehouse_id,zone_code,work_id,source_order_type,station_code,bucket_code,face,state,created_app,created_date,updated_app,updated_date,project_code
