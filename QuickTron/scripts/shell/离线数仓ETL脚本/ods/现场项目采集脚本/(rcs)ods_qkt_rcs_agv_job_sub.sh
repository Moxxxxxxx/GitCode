...
######### 设置表的变量
dbname=ods
table=ods_qkt_rcs_agv_job_sub
outdir=/data/sqoop/logs/hcatalog
target_dir=/warehouse/hive/ods/
mysql_dbname=evo_rcs
mysql_table=agv_job_sub
...
###################### agv_job_sub->ods_qkt_rcs_agv_job_sub(T-1每日增量->分区)
...
## 参数
columns=id,create_time,update_time,agv_code,class_name,content,is_last,job_id,sequence,state,sub_job_id,update_by,project_code
...
use $dbname;
insert overwrite table dwd.dwd_rcs_agv_job_sub_info partition(d,pt)
select 
id,
