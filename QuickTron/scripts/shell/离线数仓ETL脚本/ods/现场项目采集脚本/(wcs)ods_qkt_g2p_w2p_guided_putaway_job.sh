...
######### 设置表的变量
dbname=ods
table=ods_qkt_g2p_w2p_guided_putaway_job
outdir=/data/sqoop/logs/hcatalog
target_dir=/warehouse/hive/ods/
mysql_dbname=evo_wcs_g2p
mysql_table=w2p_guided_put_away_job
...
###################### w2p_guided_put_away_job->ods_qkt_g2p_w2p_guided_putaway_job(T-1每日全量->分区)
...
## 参数
columns=id,warehouse_id,zone_code,job_id,job_type,state,agv_code,agv_type,priority,order_id,order_type,work_id,detail_id,sku_id,lot_id,pack_id,frozen,package_type,owner_code,quantity,fullfill_quantity,qty_mismatch_reason,new_bucket_slot_code,level3_inventory_id,container_code,bucket_code,bucket_slot_code,container_transfer_job_id,container_move_job_id,station_code,station_slot_code,source_way_point_code,station_waypoint_code,created_app,created_date,updated_app,updated_date,project_code
### 第一次初始化脚本
init_sql="
