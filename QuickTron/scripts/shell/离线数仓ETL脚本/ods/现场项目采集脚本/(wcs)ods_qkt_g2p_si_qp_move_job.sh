...
######### 设置表的变量
dbname=ods
table=ods_qkt_g2p_si_qp_move_job
...
###################### si_qp_move_job->ods_qkt_g2p_si_qp_move_job(T-1每日增量量->分区)
...
## 参数
columns=id,,warehouse_id,,zone_code,,job_id,,job_type,,state,,priority,,priority_type,,container_code,,biz_type,,move_type,,source_height,,target_height,,target_area,,source_bucket_code,,source_bucket_slot_code,,target_bucket_code,,target_bucket_slot_code,,source_point_code,,target_point_code,,agv_code,,agv_type,,created_app,,created_date,,updated_app,,updated_date,,project_code
### 第一次初始化脚本
init_sql="
