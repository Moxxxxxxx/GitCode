...
######### 设置表的变量
dbname=ods
table=ods_qkt_rcs_agv_job_history
outdir=/data/sqoop/logs/hcatalog
target_dir=/warehouse/hive/ods/
mysql_dbname=evo_rcs
mysql_table=agv_job_history
...
###################### agv_job_history->ods_qkt_rcs_agv_job_history(T-1每日增量量->分区)
...
## 参数
columns=id,create_time,update_time,action_point_code,action_state,agv_code,bucket_id,bucket_point_code,can_interrupt,dest_point_code,is_let_down,is_report_event,job_context,job_id,job_mark,job_priority,job_state,job_type,own_job_type,src_job_type,top_face_list,warehouse_id,zone_code,project_code
### 第一次初始化脚本
init_sql="
