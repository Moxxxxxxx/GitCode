...
######### 设置表的变量
dbname=ods
table=ods_qkt_picking_order_detail
outdir=/data/sqoop/logs/hcatalog
target_dir=/warehouse/hive/ods/
mysql_dbname=evo_wes_picking
mysql_table=picking_order_detail
...
###################### picking_order_detail->ods_qkt_picking_order_detail(T-1每日增量量->分区)
