...
######### 设置表的变量
dbname=ods
table=ods_qkt_cyclecount_cycle_count_state_change
outdir=/data/sqoop/logs/hcatalog
target_dir=/warehouse/hive/ods/
mysql_dbname=evo_wes_cyclecount
mysql_table=cycle_count_state_change
...
###################### cycle_count_state_change->ods_qkt_cyclecount_cycle_count_state_change(T-1每日增量量->分区)
...
## 参数
columns=id,warehouse_id,cycle_count_id,state,remark,created_date,created_user,created_app,last_updated_date,last_updated_user,last_updated_app,project_code
