...
#-- 运行类型 ： 日跑
#-- 参数 ：     d 
#-- 功能描述 ： 采集superset可视化报表的dashboards_slices映射数据
#-- 注意 ： 全量采集，不分区
#-- 输入表 : superset.dashboard_slices
#-- 输出表 ：ods.ods_qkt_report_dashboard_slices_ful
...
######### 设置表的变量
dbname=ods
table=ods_qkt_report_dashboard_slices_ful
outdir=/data/sqoop/logs/hcatalog
target_dir=/warehouse/hive/ods/
mysql_dbname=superset
mysql_table=dashboard_slices
