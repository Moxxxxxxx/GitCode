...
#-- 运行类型 ： 日跑
#-- 参数 ：     d 
#-- 功能描述 ： 采集superset可视化报表的dashboards数据
#-- 注意 ： 全量采集，不分区
#-- 输入表 : superset.dashboards
#-- 输出表 ：ods.ods_qkt_report_dashboards_ful
...
######### 设置表的变量
dbname=ods
table=ods_qkt_report_dashboards_ful
outdir=/data/sqoop/logs/hcatalog
target_dir=/warehouse/hive/ods/
mysql_dbname=superset
mysql_table=dashboards
...
--query "select
 created_on, changed_on, id, dashboard_title, position_json, created_by_fk, changed_by_fk, css, description, slug, json_metadata, published, uuid
