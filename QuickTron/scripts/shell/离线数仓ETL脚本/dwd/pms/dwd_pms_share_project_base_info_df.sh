...
where d='${pre1_date}' and wbsmc rlike '^(转售后|项目交接|第一次实施入场|上线验收|终验|接口业务场景联调|业务场景联调|Interface service scenario joint debugging|下发发货通知)'
group by xmbm1
),
...
a.bz as currency, 
a.rmbhtzje as contract_rmb_amount,
