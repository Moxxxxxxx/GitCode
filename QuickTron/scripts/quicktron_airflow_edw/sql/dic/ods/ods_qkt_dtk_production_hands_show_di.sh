...
#-- 运行类型 ： 日跑
#-- 参数 ：     d 
#-- 功能描述 ： 采集钉钉-产线举手单数据信息记录
#-- 注意 ： 每天增量，每天一个增量分区
#-- 输入表 : quality_data.dingtalk_production_hands_show
#-- 输出表 ：ods.ods_qkt_dtk_production_hands_show_di
...
######### 设置表的变量
ods_dbname=ods
table=ods_qkt_dtk_production_hands_show_di
outdir=/data/sqoop/logs/hcatalog
target_dir=/warehouse/hive/ods/
mysql_dbname=quality_data
mysql_table=dingtalk_production_hands_show
...
symptom_description, 
exception_description_picture, 
confirmation_response, 
liability_judgment, 
judgment_basis_description, 
problem_cause_analysis, 
interim_measures, 
question_type, 
dt_create_time, 
dt_update_time
