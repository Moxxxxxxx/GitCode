...
#-- 运行类型 ： 日跑
#-- 参数 ：     d 
#-- 功能描述 ： 采集钉钉 宝仓加班申请单信息记录
#-- 注意 ： 每天增量
#-- 输入表 : quality_data.dingtalk_overtime_application_form
#-- 输出表 ：ods.ods_qkt_dtk_process_overtime_form_di
...
######### 设置表的变量
ods_dbname=ods
table=ods_qkt_dtk_process_overtime_form_di
outdir=/data/sqoop/logs/hcatalog
target_dir=/warehouse/hive/ods/
mysql_dbname=quality_data
mysql_table=dingtalk_overtime_application_form
