...
#-- 注意 ：  每日t-1增量分区
#-- 输入表 : 
#-- 输出表 ：ods.ods_qkt_devops_env_update_record_di
#-- 修改历史 ： 修改人 修改时间 主要改动说明
#-- 1 wangziming 2022-08-03 CREATE  初始化分区
# --------------------------------------------------------------------------------------------------


dbname=ods
table=ods_qkt_devops_env_update_record_di
...
json_name=ods_qkt_devops_env_update_record_di.json
