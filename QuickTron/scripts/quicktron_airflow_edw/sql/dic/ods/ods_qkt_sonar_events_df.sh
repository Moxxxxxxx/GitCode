...
#-- 功能描述 ： sonar事件信息
#-- 注意 ：每日T-快照日期跑
#-- 输入表 : quality_data.sonar_events
#-- 输出表 ：ods.ods_qkt_sonar_events_df
...
######### 设置表的变量
ods_dbname=ods
table=ods_qkt_sonar_events_df
outdir=/data/sqoop/logs/hcatalog
target_dir=/warehouse/hive/ods/
mysql_dbname=quality_data
mysql_table=sonar_events
...
--query "select 
uuid, analysis_uuid, name, category, description, event_data, event_date, created_at, component_uuid
