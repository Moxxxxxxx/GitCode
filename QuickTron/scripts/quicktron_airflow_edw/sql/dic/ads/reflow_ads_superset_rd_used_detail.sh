...
truncate table ads.ads_superset_rd_used_detail; 
...
##表：研发看板成员使用明细 ads_superset_rd_used_detail
sqoop export -D mapred.job.queue.name=hive \
--connect "jdbc:mysql://007.bg.qkt:3306/ads?useUnicode=true&characterEncoding=utf-8" \
--username root \
--password quicktron123456 \
--table ads_superset_rd_used_detail \
--export-dir hdfs://001.bg.qkt:8020/user/hive/warehouse/ads.db/ads_superset_rd_used_detail \
--num-mappers 1  \
--input-null-string '\\N' \
