...
#-- 注意 ： 每天T-1记录所有数据
#-- 输入表 : ods.ods_qkt_devops_env_deploy_record_df、ods.ods_qkt_devops_user_df、ods.ods_qkt_devops_asset_record_df
#-- 输出表 : dwd.dwd_devops_env_deploy_record_info_df
#-- 修改历史 ： 修改人 修改时间 主要改动说明
#-- 1 wangziming 2022-06-01 CREATE 
#-- 2 wangziming 2022-06-06 modify 增加部署完成时间字段
#-- 3 wangziming 2022-08-05 modify 修改ods为全量表
# ------------------------------------------------------------------------------------------------
...
from 
${ods_dbname}.ods_qkt_devops_env_deploy_record_df a
