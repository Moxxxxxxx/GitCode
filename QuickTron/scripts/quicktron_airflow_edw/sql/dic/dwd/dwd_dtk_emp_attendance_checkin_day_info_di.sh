...
#-- 2 wangziming 2022-09-07 modify 增加考勤类型字段（考勤签到类型：1.考勤机打卡（指纹/人脸打卡）2.用户打卡 3.自动打卡 4.审批系统 5.钉钉签到）
...
type_map[att_checkin_start_time] as start_att_checkin_type,
type_map[att_checkin_end_time] as end_att_checkin_type,
...
map(nvl(a.attendance_working_time,'11'),attendance_working_source,nvl(a.attendance_off_time,'12'),attendance_off_source,nvl(b.first_checkin_time,'13'),att_checkin_type,nvl(b.last_checkin_time,'14'),att_checkin_type) as type_map
