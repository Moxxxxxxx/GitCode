...
#-- 注意 ： 
#-- 输入表 : ods.ods_qkt_collect_sys_breakdown_di
#-- 输出表 ：dwd.dwd_sys_breakdown_info_df
#-- 修改历史 ： 修改人 修改时间 主要改动说明
#-- 1 wangziming 2021-11-10 CREATE 
#-- 2 wangziming 2021-12-09 modify 修改清洗逻辑
# ------------------------------------------------------------------------------------------------
...
project_code as pt
from
${ods_dbname}.ods_qkt_collect_sys_breakdown_di
where d='${pre1_date}' and lower(project_name) not like '%test%'
...
pt
from 
${dwd_dbname}.dwd_sys_breakdown_info_df
where d='${pre2_date}'
;
"
