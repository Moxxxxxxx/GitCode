...
#-- 运行类型 ： 日跑
#-- 参数 ：     d 
#-- 功能描述 ： bpm dwd层  流程表单，表头实例数据基础数据
#-- 注意 ： 每日按天全量分区
#-- 输入表 : ods.ods_qkt_bpm_app_K3flowentry_df
#-- 输出表 ：dwd.dwd_bpm_app_K3flowentry_info_ful
...
insert overwrite table ${dwd_dbname}.dwd_bpm_app_K3flowentry_info_ful 
select 
${columns}
from 
${ods_dbname}.ods_qkt_bpm_app_K3flowentry_df
where d='${pre1_date}'
;
"
