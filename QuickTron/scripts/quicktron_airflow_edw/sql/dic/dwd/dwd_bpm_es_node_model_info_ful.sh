...
#-- 运行类型 ： 日跑
#-- 参数 ：     d 
#-- 功能描述 ： bpm dwd层  流程模型-流程环节表
#-- 注意 ： 每日按天全量分区
#-- 输入表 : ods.ods_qkt_bpm_es_nodemodel_df
#-- 输出表 ：dwd.dwd_bpm_es_node_model_info_ful
...
insert overwrite table ${dwd_dbname}.dwd_bpm_es_node_model_info_ful
select 
...
Requirement
from 
${ods_dbname}.ods_qkt_bpm_es_nodemodel_df
where d='${pre1_date}'
;
"
