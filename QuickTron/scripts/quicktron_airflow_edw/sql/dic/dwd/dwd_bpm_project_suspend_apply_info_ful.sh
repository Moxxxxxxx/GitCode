...
-- 82599
insert overwrite table ${dwd_dbname}.dwd_bpm_project_suspend_apply_info_ful
select 
a.FlowID as flow_id,
...
regexp_replace(string2,'\t|\n|\r','') as project_name,
string3 as project_level,
string4 as project_status,
string5 as customer_name,
string6 as customer_level,
string7 as sale_region,
string8 as industry_type,
string16 as sales_manager,
string17 as sales_manager_id,
substr(date1,1,10) as suspend_date,
string9 as suspend_expalin,
string10 as suspend_reason_analysis,
...
where a.oFlowModelID = '82599' and a.d='${pre1_date}'
;
