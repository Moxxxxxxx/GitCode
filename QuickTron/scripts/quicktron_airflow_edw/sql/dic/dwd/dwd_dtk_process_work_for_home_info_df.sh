...
#-- 功能描述 ： 钉钉居家办公审批记录信息
#-- 注意 ： 每天全量分区
#-- 输入表 : ods.ods_qkt_dtk_process_work_for_home_df，dwd.dwd_dtk_emp_info_df
#-- 输出表 ：dwd.dwd_dtk_process_work_for_home_info_df
...
insert overwrite table ${dwd_dbname}.dwd_dtk_process_work_for_home_info_df partition(d='${pre1_date}')
select 
if(org_name='上海快仓智能','上海快仓智能科技有限公司',org_name) as org_name,
process_instance_id,
cc_userids,
...
from 
${ods_dbname}.ods_qkt_dtk_process_work_for_home_df a
