...
insert overwrite table ${dwd_dbname}.dwd_ones_testcase_info_ful
select
uuid,
team_uuid,
library_uuid,
...
assign,
desc as case_desc,
to_utc_timestamp(create_time*1000,'GMT-8') as create_time,
number,
status,
condition,
name_pinyin as case_ename,
to_utc_timestamp(update_time*1000,'GMT-8') as update_time,
updater
from 
${ods_dbname}.ods_qkt_ones_testcase_case_df 
where d='${pre1_date}'
;
"
