...
#-- 运行类型 ： 日跑
#-- 参数 ：     d 
#-- 功能描述 ： 项目wes 盘点单状态变化信息数据
#-- 注意 ： 每日T-1增量分区,每天的分区即是每天的数据
#-- 输入表 : evo_wes_cyclecount.cycle_count_work_state_change
#-- 输出表 ：ods.ods_qkt_cyclecount_cycle_count_work_state_change_da
...
######### 设置表的变量
ods_dbname=ods
table=ods_qkt_cyclecount_cycle_count_work_state_change_da
