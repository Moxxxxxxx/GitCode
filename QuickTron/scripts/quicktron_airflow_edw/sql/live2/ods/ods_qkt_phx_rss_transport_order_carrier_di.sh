...
#-- 功能描述 ： 3.x项目潜伏式搬运单表
#-- 注意 ： 每日T-1增量分区
#-- 输入表 : phoenix_rss.transport_order_carrier
#-- 输出表 ：ods.ods_qkt_phx_rss_transport_order_carrier_di
...
######### 设置表的变量
ods_dbname=ods
table=ods_qkt_phx_rss_transport_order_carrier_di
outdir=/data/sqoop/logs/hcatalog
target_dir=/warehouse/hive/ods/
mysql_dbname=phoenix_rss
mysql_table=transport_order_carrier
