...
#-- 功能描述 ： 料箱到人盘点任务表
#-- 注意 ： 每日按天增量分区
#-- 输入表 : evo_wes_cyclecount.w2p_cycle_count_job
#-- 输出表 ：ods.ods_qkt_countcheck_w2p_countcheck_job_di
...
######### 设置表的变量
ods_dbname=ods
table=ods_qkt_countcheck_w2p_countcheck_job_di
outdir=/data/sqoop/logs/hcatalog
target_dir=/warehouse/hive/ods/
mysql_dbname=evo_wes_cyclecount
mysql_table=w2p_cycle_count_job
