...
#-- 功能描述 ： 现场工作站槽位绑定订单历史表
#-- 注意 ：  每日T-1增量分区
#-- 输入表 : evo_station.station_slot_binding_history
#-- 输出表 ：ods.ods_qkt_station_slot_binding_ful_di
...
######### 设置表的变量
ods_dbname=ods
table=ods_qkt_station_slot_binding_ful_di
outdir=/data/sqoop/logs/hcatalog
target_dir=/warehouse/hive/ods/
mysql_dbname=evo_station
mysql_table=station_slot_binding_history
