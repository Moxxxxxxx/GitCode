...
#-- 运行类型 ： 日跑
#-- 参数 ：     d 
#-- 功能描述 ： 项目wes 商品盘点信息记录表
#-- 注意 ： 每日T-1增量分区
#-- 输入表 : evo_wes_cyclecount.cycle_count_by_sku
#-- 输出表 ：ods.ods_qkt_cyclecount_cycle_count_by_sku_di
...
######### 设置表的变量
ods_dbname=ods
table=ods_qkt_cyclecount_cycle_count_by_sku_di
