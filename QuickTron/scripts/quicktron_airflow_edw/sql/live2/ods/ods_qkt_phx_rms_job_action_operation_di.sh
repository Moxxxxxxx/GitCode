...
#-- 功能描述 ： 3.x项目任务移动操作记录
#-- 注意 ： 每日T-1增量分区
#-- 输入表 : phoenix_rms.job_action_operation_record
#-- 输出表 ：ods.ods_qkt_phx_rms_job_action_operation_di
...
######### 设置表的变量
ods_dbname=ods
table=ods_qkt_phx_rms_job_action_operation_di
outdir=/data/sqoop/logs/hcatalog
target_dir=/warehouse/hive/ods/
mysql_dbname=phoenix_rms
mysql_table=job_action_operation_record
