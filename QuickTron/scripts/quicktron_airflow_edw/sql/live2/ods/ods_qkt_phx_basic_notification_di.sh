...
#-- 功能描述 ： 3.x项目系统告警通知信息表
#-- 注意 ： 每日T-1增量分区
#-- 输入表 : phoenix_basic.basic_notification
#-- 输出表 ：ods.ods_qkt_phx_basic_notification_di
...
######### 设置表的变量
ods_dbname=ods
table=ods_qkt_phx_basic_notification_di
outdir=/data/sqoop/logs/hcatalog
target_dir=/warehouse/hive/ods/
mysql_dbname=phoenix_basic
mysql_table=basic_notification
