...
#-- 功能描述 ： 3.x项目作业单状态记录表
#-- 注意 ： 每日T-1增量分区
#-- 输入表 : phoenix_rss.transport_order_link
#-- 输出表 ：ods.ods_qkt_phx_rss_transport_order_link_di
...
######### 设置表的变量
ods_dbname=ods
table=ods_qkt_phx_rss_transport_order_link_di
outdir=/data/sqoop/logs/hcatalog
target_dir=/warehouse/hive/ods/
mysql_dbname=phoenix_rss
mysql_table=transport_order_link
