...
#-- 运行类型 ： 日跑
#-- 参数 ：     d 
#-- 功能描述 ： 项目station 工作站任务
#-- 注意 ： 每日按天增量分区
#-- 输入表 : evo_station.station_task_state_change
#-- 输出表 ：ods.ods_qkt_station_station_task_state_change_da
...
######### 设置表的变量
ods_dbname=ods
table=ods_qkt_station_station_task_state_change_da
