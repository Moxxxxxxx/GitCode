...
#-- 运行类型 ： 日跑
#-- 参数 ：     d 
#-- 功能描述 ： 项目wes 入库作业单上架明细
#-- 注意 ： 每日按天增量分区
#-- 输入表 : evo_wes_replenish.replenish_work_fulfill_detail
#-- 输出表 ：ods.ods_qkt_replenish_work_fulfill_detail_di
...
######### 设置表的变量
ods_dbname=ods
table=ods_qkt_replenish_work_fulfill_detail_di
