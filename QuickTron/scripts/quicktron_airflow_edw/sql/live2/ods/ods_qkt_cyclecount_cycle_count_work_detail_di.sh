...
#-- 功能描述 ： 项目wes 盘点作业单明细
#-- 注意 ： 每日T-1增量分区
#-- 输入表 : evo_wes_cyclecount.cycle_count_work_detail
#-- 输出表 ：ods.ods_qkt_cyclecount_cycle_count_work_detail_di
...
######### 设置表的变量
ods_dbname=ods
table=ods_qkt_cyclecount_cycle_count_work_detail_di
