...
#-- 运行类型 ： 日跑
#-- 参数 ：     d 
#-- 功能描述 ： 项目wes 出库作业单状态变化
#-- 注意 ： 每日按天增量分区
#-- 输入表 : evo_wes_picking.picking_work_state_change
#-- 输出表 ：ods.ods_qkt_picking_work_state_change_da
...
######### 设置表的变量
ods_dbname=ods
table=ods_qkt_picking_work_state_change_da
