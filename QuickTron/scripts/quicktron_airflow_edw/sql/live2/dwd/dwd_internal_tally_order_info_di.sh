...
insert overwrite table ${dwd_dbname}.dwd_internal_tally_order_info_di partition(d,pt)
select 
id,
tally_order_number,
owner_code,
...
from
${ods_dbname}.ods_qkt_internal_tally_order_di
) t
where t.rn=1
...
tmp_tally_order_str2 as (
select 
b.*
from 
tmp_tally_order_str1 a
inner join ${dwd_dbname}.dwd_internal_tally_order_info_di b on a.d=b.d and a.project_code=b.pt
)
insert overwrite table ${dwd_dbname}.dwd_internal_tally_order_info_di partition(d,pt)
select 
id,
