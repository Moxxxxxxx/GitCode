...
#-- 功能描述 ： 项目 dwd层  作业单明细
#-- 注意 ： 每日按天增量分区
#-- 输入表 : ods.ods_qkt_picking_work_detail_di
#-- 输出表 ：dwd.dwd_picking_work_detail_info_di
...
insert overwrite table ${dwd_dbname}.dwd_picking_work_detail_info_di partition(d,pt)
select 
id,
picking_work_id,
...
from ${ods_dbname}.ods_qkt_picking_work_detail_di
