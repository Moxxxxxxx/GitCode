...
#-- 运行类型 ： 日跑
#-- 参数 ：     d 
#-- 功能描述 ： 项目 dwd层  DSP系统配置
#-- 注意 ： 每日按天全量分区
#-- 输入表 : ods.ods_qkt_rcs_dsp_system_config_df
#-- 输出表 ：dwd.dwd_rcs_dsp_system_config_info_df
...
insert overwrite table ${dwd_dbname}.dwd_rcs_dsp_system_config_info_df partition(d,pt)
select 
id,
config_group,
warehouse_id,
...
project_code as pt
from 
${ods_dbname}.ods_qkt_rcs_dsp_system_config_df
where d='${pre1_date}' 
;
"
