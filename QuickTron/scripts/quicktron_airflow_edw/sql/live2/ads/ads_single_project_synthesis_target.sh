...
(
  ...
  (
    ...
    (
      ...
      INNER JOIN ${dwd_dbname}.dwd_g2p_job_state_change_info_da jsc 
...
(
  ...
  (
    ...
    FROM ${dwd_dbname}.dwd_station_station_entry_info_di se
...
(
  ...
  WHERE bb.d = '${pre1_date}' AND bb.bucket_state = 'effective' AND ((bb.pt = 'A51118' AND bb.bucket_type_id = 57) OR (bb.pt = 'A51149' AND bb.bucket_type_id IN (33,36,37)) OR (bb.pt = 'A51264' AND bb.bucket_type_id = 1) OR (bb.pt = 'A51203' AND bb.bucket_type_id IN (124,119)) OR (bb.pt = 'C35052' AND bb.bucket_type_id IN (122,128)) OR (bb.pt = 'A51475' AND bb.bucket_type_id IN (117,118,119,121))) -- 正常货架
...
(
  ...
  FROM ${dwd_dbname}.dwd_station_station_entry_info_di s
...
(
  ...
  FROM ${dwd_dbname}.dwd_rcs_basic_agv_info_df b
